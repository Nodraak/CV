...
\nodCvItem
    ...
    {
        \nodItemMission{In collaboration with a team of 25 people, I designed and built a \textbf{nano satellite} in order to study a new de-orbit technique using Earth's magnetic field.}
        \nodItemMission{
...
\nodCvItem
    ...
    {
        \nodItemMission{With a team of 5, \textbf{we built an autonomous robot} for the French Robotic cup.}
