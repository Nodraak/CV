...
\nodCvItem
    ...
    {Embedded Software Engineer - Exomars}
    {
        ...
        \nodItemSkill{Skills: programming (embedded C, Python), unit and integration testing (VectorCast, Tsim, Leon 2 FT on Rasta), quality tools (Cppcheck, Gitlab CI, code coverage), software development standards (MISRA-C, ECSS-40B).}
    }
...
\nodCvItem
    ...
    {Software Engineer - Robot Gali X}
    {
        ...
        \nodItemSkill{Skills: embedded C/C++, Python (telemetry GUI, software-in-the-loop simulation), drivers for CAN bus and other peripherals, ARM \si{\micro}controllers, Git.}
...
\cventry{German}{Notions}{Eager to \newline{} improve}{}{}{}
...
\cvitem{Sports}{Roller skating, social dancing}
