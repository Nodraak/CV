...
\AfterPreamble{
    \hypersetup{
        pdftitle={Adrien Chardon's Resumé},
        pdfsubject={},
    }
}
...
\nodCvItem
    ...
    {2023-04 - Present}
    {Berlin, Germany}
    {Senior Software Engineer - SIGI satellite}
    {
        \nodItem{\textit{%
            Contributing to the SIGI mission, Reflex's first demonstrator.
            The mission, a 120 kg satellite to be launch in fall 2024, will prove the avionics (designed and manufactured in-house), as well as fly a customer payload.
        }}
        \nodItem{\textbf{Architecture and development} of the software, with a focus on mission-level features (internal communication bus, TM/TC-ground chain, datapool, thermal/power/etc subsystems, integration of Matlab/Simulink-generated code).}
        \nodItem{\textbf{Testing and quality assurance}: bring-up of hardware, SIL and HIL testing, development of a custom embedded systems testing framework, code reviews}.
        \nodItem{\textbf{Technologies}: ARM microcontrollers (Zynq Ultrascale+, TMS570), RTEMS, NASA cFS, C, Python, Rust, Git, CMake.}
    }
\nodCvItem
    {PTS}
    {2021-01 - 2023-03}
...
%         \nodItem{\textbf{Electronics:} prototype PCB schematic and routing (Kickad), soldering and testing.}
%     }
...
%%%%%%%%%%%%%%%%%%%%
\nodSection{Hobbies and Side Projects}
%%%%%%%%%%%%%%%%%%%%

\setlength{\hintscolumnwidth}{30mm}

\cvitem{Writing}{\url{https://blog.nodraak.fr}}
\cvitem{Side projects}{Moon Lander GNC software written in Rust (\httplink[Learn more on my blog]{blog.nodraak.fr/series/aerospace-simulator/}, \httplink[Source code]{github.com/Nodraak/MoonLander.rs})}
\cvitem{}{Running performance analysis (\httplink[Source code]{github.com/Nodraak/Running})}
